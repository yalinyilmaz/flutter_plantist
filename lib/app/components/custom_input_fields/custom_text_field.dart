...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      cursorColor: context.mainColor.shade900,
      decoration: InputDecoration(
          contentPadding: const EdgeInsets.all(20),
          enabledBorder: widget.inputBorder ??
              UnderlineInputBorder(
                  borderSide: BorderSide(color: context.mainColor.shade100)),
          focusedBorder: widget.inputBorder ??
              UnderlineInputBorder(
                  borderSide: BorderSide(color: context.mainColor.shade100)),
          hintText: widget.hintText,
          hintStyle: widget.hintStyle ??
              context.textTheme.calloutEmphasized.copyWith(
                  color: context.mainColor.shade400,

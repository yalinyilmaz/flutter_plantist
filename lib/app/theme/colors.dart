...
class CustomColor {
  ...
  static CustomColor appPinkColor = const CustomColor(
    shade50: Color(0xFFFFF0F5),
    shade100: Color(0xFFFFE1EB),
    shade200: Color(0xFFFFC1D3),
    shade300: Color(0xFFFFA1BB),
    shade400: Color(0xFFFF82A4),
    shade500: Color(0xFFFF638C),
    shade600: Color(0xFFDB4A76),
    shade700: Color(0xFFB73661),
    shade800: Color(0xFF93264D),
    shade900: Color(0xFF7A1A3F),
  );
